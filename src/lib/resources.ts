...
export const articles: Article[] = [
  {
    ...
    excerpt:
      "Demystifying AI implementation costs. Learn what to expect for software licensing, custom setup fees, and maintenance costs.",
    date: "July 1, 2026",
    readTime: "5 min read",
  ...
  },
  {
    ...
    excerpt:
      "Are repetitive administrative tasks holding back your growth? Discover the operational symptoms that signal it's time for an AI systems audit.",
    date: "June 25, 2026",
    readTime: "4 min read",
  ...
  },
  {
    ...
    excerpt:
      "Struggling with high ingredient costs and table occupancy? A simple guide on implementing AI automation for cafe and restaurant operations.",
    date: "June 18, 2026",
    readTime: "6 min read",
