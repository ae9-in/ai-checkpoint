...
const industryDetails: Record<string, IndustryDetail> = {
  retail: {
    ...
    metaDesc: "Automate retail checkout, inventory management, and predict customer demand. Get a customized retail AI operations audit from AI CheckPoint.",
  ...
  restaurants: {
    ...
    metaDesc: "Slash food waste and manage recipe margins. Deploy custom order prediction and guest preference AI with AI CheckPoint in 48 hours.",
  ...
  healthcare: {
    ...
    metaDesc: "Automate patient appointments, diagnostic reports, and medical billing. Compliant and secure AI solutions for clinics by AI CheckPoint.",
  ...
  salons: {
    ...
    metaDesc: "Automate salon bookings and client retention. Deploy 24/7 WhatsApp AI schedulers and automated marketing campaigns with AI CheckPoint.",
  ...
  gyms: {
    ...
    metaDesc: "Spot gym membership churn early. Deploy automated trainer scheduling and membership reactivation campaigns with AI CheckPoint.",
  ...
  education: {
    ...
    metaDesc: "Reduce teacher administrative burden. Automate school attendance, student performance analytics, and fee collections using AI.",
  ...
  "real-estate": {
    ...
    metaDesc: "Score real estate leads, match property listings, and automate agreement drafting with custom AI systems from AI CheckPoint.",
  ...
  logistics: {
    ...
    metaDesc: "Optimize delivery routes, automate dispatching, and compute accurate ETAs. Reduce logistics overhead with AI CheckPoint systems.",
  ...
  manufacturing: {
    ...
    metaDesc: "Deploy computer vision quality control and predictive maintenance models on your factory floor with AI CheckPoint.",
  ...
  corporate: {
    ...
    metaDesc: "Automate HR tasks, route support tickets, and build custom data analytics dashboards with AI CheckPoint corporate systems.",
        ...
        <div className="mx-auto max-w-4xl px-6 relative z-10">
          ...
          <div className="text-center pt-8">
            ...
            <p className="text-sm text-soft/50 mb-8 max-w-lg mx-auto">
              Schedule your free operations audit today. We'll identify bottlenecks and design your custom AI integration.
            </p>
            <Link
              to="/register"
