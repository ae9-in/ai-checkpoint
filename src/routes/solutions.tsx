  ...
  head: () => ({
    meta: [
      { title: "AI Automation Solutions for Businesses — AI CheckPoint" },
      {
        name: "description",
        content:
          "Discover how AI CheckPoint eliminates operational waste, automates repetitive workflows, and reduces costs for Indian businesses. Secure your custom AI roadmap.",
      },
      { property: "og:title", content: "AI Automation Solutions for Businesses — AI CheckPoint" },
      {
        property: "og:description",
        content:
          "Cut costs, increase accuracy, and outpace competition with tailored AI solutions.",
      },
    ],
    links: [
      {
...
function SolutionsPage() {
  ...
  const serviceSchema = {
    ...
    description:
      "We audit your business processes and deploy automated custom AI systems to cut operational costs and labor waste.",
    areaServed: "IN",
  };
